...
const getProductsByTitleAsc = async (req, res) => {
  try {
    let result = await Product.find({}, "-_id -__v").sort({title: 1}).populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductsByPriceAsc = async (req, res) => {
  try {
    let result = await Product.find({}, "-_id -__v").sort({price: 1, title: 1}).populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductsByStarsAsc = async (req, res) => {
  try {
    let result = await Product.find({}, "-_id -__v").sort({stars: 1, title: 1}).populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductsByKeyword = async (req, res) => {
  try {
    ...
    let result = await Product.find({title: {$regex: title}}, "-_id -__v").populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductByTitle = async (req, res) => {
  try {
    let title = req.params.title;
    let result = await Product.findOne({title: title}, "-_id -__v").populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductById = async (req, res) => {
  try {
    ...
    let result = await Product.findOne({id: id}, "-_id -__v").populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductsByPrice = async (req, res) => {
  try {
    ...
    let result = await Product.find({price: price}, "-_id -__v").populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
...
const getProductsByStars = async (req, res) => {
  try {
    ...
    let result = await Product.find({stars: stars}, "-_id -__v").populate("provider", "-_id");
    res.status(200).json(result);
  } catch (err) {
    console.log(err);
    throw err;
